...
More information can be found on [Creating a worker process on kendrickcoleman.com][1]

[1]: http://kendrickcoleman.com/index.php/Tech-Blog/creating-a-worker-process-on-cloud-foundry-with-clockwork.html
